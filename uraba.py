...
class Uraba(tk.Toplevel):
    ...
    def construirse(self):
        ...
        self.fondo = tk.PhotoImage(file="images/uraba.png")
        ...
        self.Amaga = tk.Button(self,text="Arboletes", command=self.ir_arboletes,font=("Monotype Corsiva",25),background="#00986C",fg="#EFFD5F").place(x=150,y=200)
        self.Amaga = tk.Button(self,text="Mutata", command=self.ir_mutata,font=("Monotype Corsiva",25),background="#00986C",fg="#EFFD5F").place(x=300,y=200)
    ...
    def ir_arboletes(self):
        self.destroy()
        arboletes.Arboletes(self.ventana_anterior)

    def ir_mutata(self):
        self.destroy()
        mutata.Mutata(self.ventana_anterior)
