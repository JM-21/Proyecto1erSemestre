...
class BajoCauca(tk.Toplevel):
    ...
    def construirse(self):
        ...
        self.fondo = tk.PhotoImage(file="images/bajocauca.png")
        ...
        self.Amaga = tk.Button(self,text="Caucacia", command=self.ir_caucacia,font=("Monotype Corsiva",25),background="#00986C",fg="#EFFD5F").place(x=150,y=200)
        self.Amaga = tk.Button(self,text="Taraza", command=self.ir_taraza,font=("Monotype Corsiva",25),background="#00986C",fg="#EFFD5F").place(x=300,y=200)
    ...
    def ir_caucacia(self):
        self.destroy()
        caucacia.Caucacia(self.ventana_anterior)

    def ir_taraza(self):
        self.destroy()
        taraza.Taraza(self.ventana_anterior)
