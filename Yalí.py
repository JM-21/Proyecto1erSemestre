...
class yalí(tk.Toplevel):
    ...
    def construirse(self):
        ...
        self.fondo = tk.PhotoImage(file="images/Yalí.png")
        ...
        lbl_titulo = tk.Label(self,
                                 text=" Bienvenido a Yalí", fg="black", 
                                 bg="green", font=("Monotype Corsiva", 20))
        lbl_titulo.pack
        lbl_titulo.place(x= 320, y=100)

        lbl_texto = tk.Label(self, 
                             text="Yalí “La Ciudad de las Tres Colinas”, apelativo correspondiente a \n la posición privilegiada que posee este municipio, ya que está localizado \n en la cresta de una de las estribaciones de la Cordillera Central de \n los Andes colombianos, considerado por sus habitantes como de las mejores vistas \n para observar la parte baja del nordeste antioqueño. Su economía se \n basa principalmente en la agricultura y el cultivo de caña de azúcar, sin dejar de \n lado la gran prominencia minera que se maneja en la región."
                             , bg="white",
                             font=("Arial", 12)
                             )
        ...
        lbl_texto = tk.Label(self, 
                             text="Fiesta de la Tetona y El Retorno (Agosto)."
                             , bg="white",
                             font=("Arial", 12)
                             )
