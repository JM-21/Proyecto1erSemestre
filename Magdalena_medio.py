...
class magdalena_medio(tk.Toplevel):
    ...
    def construirse(self):
        ...
        self.fondo = tk.PhotoImage(file="images/MMedio.png")
        ...
        lbl_titulo = tk.Label(self,
                                 text=" Bienvenido al Magdalena Medio Antioqueño \n Selecciona el pueblo de tu interes", fg="yellow", 
        ...
        self.Pt_nare = tk.Button(self,text="Puerto Nare", command=self.ir_Ptnare, font=("Monotype Corsiva",25),background="#00986C",fg="#EFFD5F").place(x=150,y=200)
        self.Pt_berrio = tk.Button(self,text="Puerto Berrio", command=self.ir_Ptberrio,font=("Monotype Corsiva",25),background="#00986C",fg="#EFFD5F").place(x=350,y=200)
    ...
    def ir_Ptnare(self):
        self.destroy()
        Pt_nare.Ptnare(self.ventana_anterior)

    def ir_Ptberrio(self):
        self.destroy()
        Pt_berrio.Ptberrio(self.ventana_anterior)
