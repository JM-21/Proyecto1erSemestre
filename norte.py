...
class Norte(tk.Toplevel):
    ...
    def construirse(self):
        ...
        self.fondo = tk.PhotoImage(file="images/norte.png")
        ...
        self.Amaga = tk.Button(self,text="San Pedro", command=self.ir_sanpedro,font=("Monotype Corsiva",25),background="#00986C",fg="#EFFD5F").place(x=150,y=200)
        self.Amaga = tk.Button(self,text="Belmira", command=self.ir_belmira,font=("Monotype Corsiva",25),background="#00986C",fg="#EFFD5F").place(x=300,y=200)
    ...
    def ir_sanpedro(self):
        self.destroy()
        san_pedro.SanPedro(self.ventana_anterior)

    def ir_belmira(self):
        self.destroy()
        belmira.Belmira(self.ventana_anterior)
