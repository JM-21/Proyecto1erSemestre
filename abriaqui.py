...
class Abriaqui(tk.Toplevel):
    ...
    def construirse(self):
        ...
        self.fondo = tk.PhotoImage(file="images/abriaqui1.png")
        ...
        lbl_titulo = tk.Label(self,
                                 text=" Bienvenido a Abriaquí", fg="black", 
                                 bg="green", font=("Monotype Corsiva", 20))
        lbl_titulo.pack
        lbl_titulo.place(x= 320, y=100)

        lbl_texto = tk.Label(self, 
                             text="Abriaquí, juega un papel clave en la región en la medida que es\n parte del nacimiento de numerosas fuentes hídricas, hace  así mismo,\n parte del Parque Nacional Natural Las Orquídeas, del distrito de\n Manejo Alto de Insor, Reserva Forestal del Pacífico (Ley 2da de 1959),\n Chocó Biogeográfico. En Abriaquí se ubica la pequeña central la Herradura,\n el cual es uno de los pocos proyectos de Mecanismo\n de Desarrollo Limpio en Colombia."
                             , bg="white",
                             font=("Arial", 12)
                             )
        ...
        lbl_texto = tk.Label(self, 
                             text="En Agosto, honramos el trabajo y dedicación de nuestros \n campesinos. Por ello tenemos Las Fiestas de la \n Antioqueñidad y del Campesino."
                             , bg="white",
                             font=("Arial", 12)
                             )
        ...
        lbl_texto = tk.Label(self, 
                             text="Tradicionalmente en el mes de diciembre tenemos \n nuestras fiestas tradicionales del municipio \n que son Las Fiestas de la leche."
                             , bg="white",
                             font=("Arial", 12)
                             )
        lbl_texto.place(x=190, y=420)
