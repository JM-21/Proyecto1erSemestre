...
class Valle_aburra(tk.Toplevel):
    ...
    def construirse(self):
        ...
        self.fondo = tk.PhotoImage(file="images/valledeaburra.png")
        ...
        lbl_titulo = tk.Label(self,
                                 text=" Bienvenido al Valle de Aburra Antioqueño \n Selecciona el pueblo de tu interes", fg="yellow", 
        ...
        self.Amaga = tk.Button(self,text="Caldas", command=self.ir_caldas,font=("Monotype Corsiva",25),background="#00986C",fg="#EFFD5F").place(x=150,y=200)
        self.Amaga = tk.Button(self,text="Barbosa", command=self.ir_barbosa,font=("Monotype Corsiva",25),background="#00986C",fg="#EFFD5F").place(x=300,y=200)
    ...
    def ir_caldas(self):
        self.destroy()
        caldas.Caldas(self.ventana_anterior)

    def ir_barbosa(self):
        self.destroy()
        barbosa.Barbosa(self.ventana_anterior)
