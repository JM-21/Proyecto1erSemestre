...
class Ptberrio(tk.Toplevel):
    ...
    def construirse(self):
        ...
        self.fondo = tk.PhotoImage(file="images/Puerto_berrio.png")
        ...
        lbl_titulo = tk.Label(self,
                                 text=" Bienvenido a Puerto Berrío", fg="black", 
                                 bg="green", font=("Monotype Corsiva", 20))
        lbl_titulo.pack
        lbl_titulo.place(x= 320, y=100)

        lbl_texto = tk.Label(self, 
                             text="Puerto Berrío es un lugar atractivo para conocer, sobre todo \n en la celebración de las Fiestas del Retorno y el Reinado de la Ecología, que son \n más tradicionales del municipio, pero también se realiza el Festival de la Cometa, \n el Festival de Danzas y Música Folclórica, el Festival del Río Magdalena entre \n muchos otros espacios culturales."
                             , bg="white",
                             font=("Arial", 12)
                             )
        ...
        lbl_texto = tk.Label(self, 
                             text="Fiestas del Retorno y Reinado Nacional de la Ecología (Junio)"
                             , bg="white",
                             font=("Arial", 12)
                             )
