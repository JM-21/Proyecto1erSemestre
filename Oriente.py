...
class oriente(tk.Toplevel):
    ...
    def construirse(self):
        ...
        self.fondo = tk.PhotoImage(file="images/Oriente.png")
        ...
        self.Abejorral = tk.Button(self,text="Abejorral", command=self.ir_abejorral, font=("Monotype Corsiva",25),background="#00986C",fg="#EFFD5F").place(x=150,y=200)
        self.Cocorná = tk.Button(self,text="Cocorná", command=self.ir_cocorná,font=("Monotype Corsiva",25),background="#00986C",fg="#EFFD5F").place(x=300,y=200)
    ...
    def ir_abejorral(self):
        self.destroy()
        Abejorral.Abejorral(self.ventana_anterior)

    def ir_cocorná(self):
        self.destroy()
        Cocorná.Cocorná(self.ventana_anterior)
