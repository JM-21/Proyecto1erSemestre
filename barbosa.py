...
class Barbosa(tk.Toplevel):
    ...
    def construirse(self):
        ...
        self.fondo = tk.PhotoImage(file="images/barbosa.png")
        ...
        lbl_titulo = tk.Label(self,
                                 text=" Bienvenido a Barbosa", fg="black", 
                                 bg="green", font=("Monotype Corsiva", 20))
        lbl_titulo.pack
        lbl_titulo.place(x= 320, y=100)

        lbl_texto = tk.Label(self, 
                             text="Barbosa es un municipio que se encuentra ubicado en el norte \ndel Valle de Aburra, posee grandes características en fuentes hídricas y naturaleza,\n donde hay variedad de fincas hoteles y así mismo realizar actividades de \nturismo cultural, turismo de aventura y agroturismo."
                             , bg="white",
                             font=("Arial", 12)
                             )
        ...
        lbl_titulo = tk.Label(self,
                                 text="Fiestas de la Piña", fg="black", 
                                 bg="green", font=("Monotype Corsiva", 14))
        lbl_titulo.pack
        lbl_titulo.place(x= 190, y=270)

        lbl_texto = tk.Label(self, 
                             text="Se celebra en la primer semana de diciembre, dias en los que el\n municipio le rinde homenaje a sus tradicciones \nen una alborada musical."
                             , bg="white",
                             font=("Arial", 12)
                             )
        ...
        lbl_titulo = tk.Label(self,
                                 text="Fiestas del Tren", fg="black", 
                                 bg="green", font=("Monotype Corsiva", 14))
        lbl_titulo.pack
        lbl_titulo.place(x= 190, y=380)
        
        lbl_texto = tk.Label(self, 
                             text="Fiestas del Tren en el corregimiento el Hatillo es realizada en \nla semana del 23 al 26 de junio,  la temática es conmemoración del \ntren, teniendo como eventos: deportivos, artísticos, culturales y \nexposiciones, tablados populares, orquestas."
                             , bg="white",
                             font=("Arial", 12)
                             )
